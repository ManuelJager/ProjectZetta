                ...
                for (int i = trail.Count-1; i >= 0; --i){
                    ...
                    if (section != null){
                        ...
                        for (int j = 0; j <= sectionSegments; ++j){
                            ...
                            uv.Set((j/(float)sectionSegments)*uvWidthFactor,vCoord);
                            uvs.Add(uv);
                        ...
                        uv.Set(vCoord,sorting == TrailSorting.NewerOnTop?uvWidthFactor:0);
                        uvs.Add(uv);
                        uv.Set(vCoord,sorting == TrailSorting.NewerOnTop?0:uvWidthFactor);
                        uvs.Add(uv);
